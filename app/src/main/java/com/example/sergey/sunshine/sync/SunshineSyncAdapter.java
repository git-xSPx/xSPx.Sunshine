package com.example.sergey.sunshine.sync;
...
import com.example.sergey.sunshine.MainActivity;
import com.example.sergey.sunshine.R;
import com.example.sergey.sunshine.Utility;
...
//    public static final int SYNC_INTERVAL = 60;
    ...
    public static final int CONNECTION_TIMEOUT = 2 * 60 * 1000; // 2 minutes
...
//                return null;
    ...
    public static void syncImmediately(Context context) {
        ...
        if (ContentResolver.isSyncPending(getSyncAccount(context), context.getString(R.string.content_authority))  ||
            ...
            Log.d(LOG_TAG, "SyncPending, canceling");
...
//                stackBuilder.addParentStack(MainActivity.class);
                ...
                mNotificationManager.notify(WEATHER_NOTIFICATION_ID, notificationBuilder.build());
    ...
    private void deleteOldData() {
        ...
        int rowsDeleted = context.getContentResolver().delete(weatherUri, WeatherContract.WeatherEntry.COLUMN_DATE + " <= ?",
